...
src="http://localhost/upwork03/img/footer-logo.png" alt="Fastsole"></a>
        <div class="menu-main-menu-container">
            <ul id="menu-main-menu" class="sidenav-menu">
                ...
                <li id="menu-item-27490" class="current-menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-27490"><a href="#">Brands</a>
                    <ul class="sub-menu">
                         <?php 
...
src="img/logo.png" class="img-responsive" alt="Fastsole"></a></div>
                                    <div class="header-middle sticky-menus-col">
                                        <div id="main-nav" class="stellarnav">
                                            ...
                                            <li class="current-menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-27490"><a href="#">Brands</a>
                                                <ul class="sub-menu">
                                                                           <?php 
                $brands=DB::table('brands')->limit(7)->get();
                foreach($brands as $key){ 
...
Stock
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <ul class="left_sidebar_field">
                                                ...
                                                <li style="display: none;"><input type="checkbox" name="vehicle[]" value="<?php echo $brandname ?>" checked>{{$brandname}}</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            </div><input type="button" class="reset_button" value="Reset" onClick="window.location.reload()"></div>
                    </div>
...
src="http://localhost/upwork03/img/sneaker_slider_2.jpg" class="img-responsive" alt="sneaker slider 2"></a>
                                <a href=""><img
src="http://localhost/upwork03/img/sneaker_slider_3.jpg" class="img-responsive" alt="sneaker slider 3"></a></div>
                        </div>
                                    ...
                                    <article id="post-35756" class="post-35756 sneaker type-sneaker status-publish has-post-thumbnail department-air-max department-nikes colour-black status-in-stock status-on-focus">
                                        <div class="single-sneaker jj">
                                            ...
                                            <div class="ih-item square colored effect6 bottom_to_top">
                                                <a href="{{url('/')}}/product/<?php echo $key->product_id ?>">
                                                    <div class="img"><img width="350" height="220" src="http://localhost/upwork03/img/<?php echo $key->image_name ?>" class="lazyOwl img-responsive wp-post-image" alt="Nike Air Max 270 Camo Heel AQ6239-001 01" /></div>
                                                </a>
                                            </div>
                                            <div class="sneaker-info">
                                                <div class="sneaker-title">
                                                    <h2><a href="{{url('/')}}/product/<?php echo $key->product_id ?>">{{$key->product_name}}</a></h2>
                                                </div>
