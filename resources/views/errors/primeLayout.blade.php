...
ul.pagination li.disabled {
    ...
    margin: 4px;
         ...
         <!-- Insert to your webpage for slider </head> -->
    <!-- <script src="http://localhost/upwork03/public/slider/sliderengine/jquery.js"></script> -->
    ...
    <script src="http://localhost/upwork03/public/slider/sliderengine2/amazingslider.js"></script>
 <link rel="stylesheet" type="text/css" href="http://localhost/upwork03/public/slidersliderengine2/amazingslider-2.css">
    <script src="http://localhost/upwork03/public/slider/sliderengine2/initslider-2.js"></script>
  ...
  <!-- box-shadow: 5px 5px 5px grey; -->
   ...
   <form class="form-inline" action="{{url('/')}}/randomSearch">
...
<nav class="navbar navbar-expand-lg  navbar-light" id="secondNav" style="padding: 0px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/wintersale">Winter Sale</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/newscatalogue">News </a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
           <?php
          $brnd=DB::table('brands')->get();
          foreach($brnd as $key){
          ?>
          <a class="dropdown-item" href="{{url('/')}}/bsearch/<?php echo $key->brand_name ?>">
            {{$key->brand_name}}
...
<form id="mc-embedded-subscribe-form" class="validate" action="" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate="">
       ...
       <script type="text/javascript">
        $("document").ready(function(){
         ...
         var owl = $('.owl-carousel');
                  ...
                  // var myVar = setInterval(function(){ resolutioncheck() }, 1000);
